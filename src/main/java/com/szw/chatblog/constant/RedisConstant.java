package com.szw.chatblog.constant;
...
public class RedisConstant {
    ...
    public static final Long LIKE_ENTITY_TTL = 1L;
    public static final String LIKE_ENTITY_COUNT_KET = "like:entity:count:";
    public static final Long LIKE_ENTITY_COUNT_TTL = 1L;
    public static final String LIKE_ENTITY_UPDATE_KEY = "like:entity:update:";
    public static final Long LIKE_ENTITY_UPDATE_TTL = 1L;
