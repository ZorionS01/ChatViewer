...
import com.szw.chatblog.dto.CategoryDto;
import com.szw.chatblog.mapper.CategoryMapper;
...
public class CategoryServiceImpl extends ServiceImpl<CategoryMapper, Category> implements CategoryService {
    ...
    public List<CategoryDto> allCategory() {
        ...
        if (BooleanUtil.isTrue(stringRedisTemplate.hasKey(RedisConstant.CATEGORY_ALL_KEY))) {
            // 先查询Redis
            String jsonStr = stringRedisTemplate.opsForValue().get(RedisConstant.CATEGORY_ALL_KEY);
            ...
            stringRedisTemplate.opsForValue().set(RedisConstant.CATEGORY_ALL_KEY, jsonStr, RedisConstant.CATEGORY_ALL_TTL, TimeUnit.MINUTES);
    ...
    public void deleteCategory(Long categoryId) {
        ...
        // 让缓存失效
        stringRedisTemplate.delete(RedisConstant.CATEGORY_ALL_KEY);
    }
