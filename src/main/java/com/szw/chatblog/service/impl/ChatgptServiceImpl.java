...
import com.szw.chatblog.event.GptEventSourceListener;
import com.szw.chatblog.exception.NoPermissionException;
import com.szw.chatblog.exception.NoTokenCountException;
import com.szw.chatblog.mapper.ChatgptMessageMapper;
import com.szw.chatblog.mapper.ConversationMapper;
...
import com.szw.chatblog.service.ChatgptService;
...
public class ChatgptServiceImpl extends ServiceImpl<ChatgptMessageMapper, ChatgptMessage> implements ChatgptService {
    ...
    public SseEmitter sendMsgSse(Boolean useToken, Long conversationId, String prompt) {
        ...
        // 8、提问 messages 为GPT提供上下文 listener
